...
-- Show 1
INSERT INTO shows (id, name, prefix, date, time) VALUES (1, 'اوبريت '''' اسرة عمانوئيل', '11', '2026-09-01', '6:30م');
...
-- Show 2
INSERT INTO shows (id, name, prefix, date, time) VALUES (2, 'كورال '''' اسرة البابا كيرلس والمريمات', '12', '2026-09-01', '8:00م');
...
-- Show 3
INSERT INTO shows (id, name, prefix, date, time) VALUES (3, 'اوبريت '''' اسرة رسل بنات', '13', '2026-09-02', '6:30م');
...
-- Show 4
INSERT INTO shows (id, name, prefix, date, time) VALUES (4, 'اوبريت '''' اسرة تيموثاوس و مورا', '14', '2026-09-02', '8:00م');
...
-- Show 5
INSERT INTO shows (id, name, prefix, date, time) VALUES (5, 'اوبريت '''' اسرة ابرار 1', '15', '2026-09-03', '6:30م');
...
-- Show 6
INSERT INTO shows (id, name, prefix, date, time) VALUES (6, 'مسرحية '''' اسرة ابرار 2', '16', '2026-09-03', '8:00م');
...
-- Show 7
INSERT INTO shows (id, name, prefix, date, time) VALUES (7, 'كورال '''' اسرة قديسين', '17', '2026-09-05', '6:30م');
...
-- Show 8
INSERT INTO shows (id, name, prefix, date, time) VALUES (8, 'مسرحية '''' اسرة قديسين', '18', '2026-09-05', '8:00م');
...
-- Show 9
INSERT INTO shows (id, name, prefix, date, time) VALUES (9, 'اوبريت '''' اسرة رسل ولاد', '19', '2026-09-06', '6:30م');
...
-- Show 10
INSERT INTO shows (id, name, prefix, date, time) VALUES (10, 'مسرحية '''' اسرة محبة', '20', '2026-09-06', '8:00م');
...
-- Show 11
INSERT INTO shows (id, name, prefix, date, time) VALUES (11, 'كورال '''' اسرة سمعان الشيخ', '21', '2026-09-07', '6:30م');
...
-- Show 12
INSERT INTO shows (id, name, prefix, date, time) VALUES (12, 'مسرحية '''' اسرة أباء', '22', '2026-09-07', '8:00م');
...
-- Show 13
INSERT INTO shows (id, name, prefix, date, time) VALUES (13, 'اوبريت '''' اسرة ماربنهام و سارة أولاد', '23', '2026-09-08', '6:30م');
...
-- Show 14
INSERT INTO shows (id, name, prefix, date, time) VALUES (14, 'مسرحية '''' اسرة ماربنهام و سارة بنات', '24', '2026-09-08', '8:00م');
...
-- Show 15
INSERT INTO shows (id, name, prefix, date, time) VALUES (15, 'اوبريت '''' اسرة اباء بنات', '25', '2026-09-09', '6:30م');
...
-- Show 16
INSERT INTO shows (id, name, prefix, date, time) VALUES (16, 'كورال '''' اسرة الشهيد بروفوريوس', '26', '2026-09-09', '8:00م');
...
-- Show 17
INSERT INTO shows (id, name, prefix, date, time) VALUES (17, 'اوبريت '''' اسرة نبيات', '27', '2026-09-12', '6:30م');
...
-- Show 18
INSERT INTO shows (id, name, prefix, date, time) VALUES (18, 'كورال '''' اسرة محبة', '28', '2026-09-12', '8:00م');
...
-- Show 19
INSERT INTO shows (id, name, prefix, date, time) VALUES (19, 'كورال '''' اسرة نيقولاوس', '29', '2026-09-13', '6:30م');
...
-- Show 20
INSERT INTO shows (id, name, prefix, date, time) VALUES (20, 'كورال '''' اسرة الانبا رويس', '30', '2026-09-13', '6:30م');
...
-- Show 21
INSERT INTO shows (id, name, prefix, date, time) VALUES (21, 'كورال '''' اسرة شهيدات', '31', '2026-09-14', '8:00م');
...
-- Show 22
INSERT INTO shows (id, name, prefix, date, time) VALUES (22, 'اوبريت '''' اسرة الانبا كاراس', '32', '2026-09-14', '6:30م');
...
-- Show 23
INSERT INTO shows (id, name, prefix, date, time) VALUES (23, 'مسرحية '''' اسرة انبياء اولاد', '33', '2026-09-15', '8:00م');
...
-- Show 24
INSERT INTO shows (id, name, prefix, date, time) VALUES (24, 'مسرحية '''' اسرة الكاروز', '34', '2026-09-15', '8:00م');
